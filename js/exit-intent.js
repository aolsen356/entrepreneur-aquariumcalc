/**
 * Exit-Intent Popup - AquariumCalc
 * Captures visitors with aquarium resources
 */

(function() {
    'use strict';

    const STORAGE_KEY = 'aqc_exit_shown';
        ...
        popup.innerHTML = `
            ...
            ">
                <svg width="32" height="32" fill="white" viewBox="0 0 24 24">
                    <path d="M20 9V7c0-1.1-.9-2-2-2H6c-1.1 0-2 .9-2 2v2c-1.1 0-2 .9-2 2v9h20v-9c0-1.1-.9-2-2-2zM6 7h12v2H6V7zm12 12H6v-7h12v7z"/>
                </svg>
            </div>
            <h3 style="font-size: 24px; font-weight: bold; margin-bottom: 12px; color: #111827;">
                Don't Leave Your Fish Hanging!
            </h3>
            <p style="color: #6B7280; margin-bottom: 24px; line-height: 1.6;">
                Bookmark our calculators for quick access to tank volume, stocking, and water chemistry tools whenever you need them.
            </p>
            ...
            <p style="font-size: 12px; color: #9CA3AF; margin-top: 16px;">
                Free aquarium tools for happy, healthy fish
            </p>
        `;
